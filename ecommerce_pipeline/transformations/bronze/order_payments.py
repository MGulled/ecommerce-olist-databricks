...
#configuration
SOURCE_PATH = "abfss://sourcedata@ecommercestg.dfs.core.windows.net/order_payments"


@dp.materialized_view(
    name="ecommerce_olist.bronze.order_payments",
    comment="Raw data processing for order payments",
    table_properties={
        "quality":"bronze",
        "layer":"bronze",
        "source_format":"csv",
